...
class Period(models.Model):
    ...
    def __str__(self):
        return f"P{self.period_number} {self.name} ({self.start_time}-{self.end_time})"
...
class Timetable(models.Model):
    STATUS = [('draft', 'Draft'), ('generating', 'Generating'),
...
class Lesson(models.Model):
    ...
    def __str__(self):
        return f"{self.subject} - {self.division} ({self.periods_per_week}/wk)"
...
class TimetableSlot(models.Model):
    ...
    def __str__(self):
        return f"{self.day} P{self.period.period_number} - {self.lesson.subject}"